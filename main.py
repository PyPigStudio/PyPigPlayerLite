...
if __name__ == '__main__':
    try:
        ...
        mouse = False
        d_num = 5
        d_pos = [((i + 0.5) * 80, 560) for i in range(d_num)]
        ledge = 10
        redge = 390
        mid = (ledge + redge) / 2
        width = redge - ledge
    ...
    while True:
        try:
            ...
            if player.opened() and not player.have_lrc():
                btn_search.show(screen, (200, 300), 60)
            statebtm = 504
            ...
            if player.is_timer_on():
                ...
                btn_plus.show(screen, (400 - tmrwid / 2 - 10,
            ...
            if player.opened():
                ...
                btn_forward.show(screen, (400 - progwid / 2 - 10,
